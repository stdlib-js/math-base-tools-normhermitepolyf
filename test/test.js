...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof normhermitepolyf, 'function', 'main export is a function' );
	t.end();
});

tape( 'attached to the main export is a `factory` method', function test( t ) {
	t.strictEqual( typeof normhermitepolyf.factory, 'function', 'has method' );
	t.end();
});
...
tape( 'the function returns `1.0` whenever `n` is `0`', function test( t ) {
	...
	y = normhermitepolyf( 0, -1.0 );
	t.strictEqual( y, 1.0, 'returns expected value.0' );

	y = normhermitepolyf( 0, 0.0 );
	t.strictEqual( y, 1.0, 'returns expected value.0' );
